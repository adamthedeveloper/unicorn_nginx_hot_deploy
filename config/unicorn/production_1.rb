...
# I work on a mac, your means of figuring out how many worker processes there should be is up to you
WORKERS_PER_CORE = 2
...
# Name the sock according to the port so that we can have separate unicorn clusters
...
# Kill unicorns with the pid file if you wish - I use an awk to find the pid - whatever you want to do
...
# Separate the logs if you want - optional.
